...
public class PlaylistReader {
    ...
    private Playlist[] readPlaylistFile(String playlistFileName)
        ...
        while (file.hasNextLine()
            ...
            if (tokens.length < 8) {
                throw new java.text.ParseException("Not enough strings", playlistCounter);
            }
            else if (tokens.length > 8) {
                throw new java.text.ParseException("Too many strings", playlistCounter);
            }
                ...
                {
                    throw new DailyMixDataException("Playist values are out of bounds");
                }
    ...
    private ArrayQueue<Song> readQueueFile(String songFileName)
        ...
        while (file.hasNextLine()) {
            ...
            {
                throw new DailyMixDataException("Invalid token value");
            }
